<template lang="html">
  <div :val="value_">
    <div>
      <el-radio v-model="type" label="1" size="mini" border>{{ $i18n.t('components.monthly') }}</el-radio>
    </div>
    <div>
    ...
    <div>
      ...
      <span style="margin-left: 5px; margin-right: 5px;">{{$i18n.t('components.monthMsg1')}}</span>
      <el-input-number @change="type = '3'" v-model="loop.end" :min="1" :max="12" size="mini" style="width: 100px;"></el-input-number>
      {{$i18n.t('components.monthMsg2')}}
    </div>
    <div>
