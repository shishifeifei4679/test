<template lang="html">
  <div :val="value_">
    <div>
      <el-radio v-model="type" label="1" size="mini" border>{{$i18n.t('components.weekly')}}</el-radio>
    </div>
    <div>
      <el-radio v-model="type" label="5" size="mini" border>{{$i18n.t('components.dont')}}</el-radio>
    </div>
    <div>
      <el-radio v-model="type" label="2" size="mini" border>{{$i18n.t('components.period')}}</el-radio>
      <span style="margin-left: 10px; margin-right: 5px;">{{$i18n.t('components.minMsg3')}}</span>
      <el-input-number @change="type = '2'" v-model="cycle.start" :min="1" :max="7" size="mini" style="width: 100px;"></el-input-number>
      <span style="margin-left: 5px; margin-right: 5px;">{{$i18n.t('components.minMsg4')}}</span>
      <el-input-number @change="type = '2'" v-model="cycle.end" :min="2" :max="7" size="mini" style="width: 100px;"></el-input-number>
    </div>
    <div>
      <el-radio v-model="type" label="3" size="mini" border>{{$i18n.t('components.circulation')}}</el-radio>
      <span style="margin-left: 10px; margin-right: 5px;">{{$i18n.t('components.minMsg3')}}</span>
      <el-input-number @change="type = '3'" v-model="loop.start" :min="1" :max="7" size="mini" style="width: 100px;"></el-input-number>
      <span style="margin-left: 5px; margin-right: 5px;">{{$i18n.t('components.minMsg1')}}</span>
      <el-input-number @change="type = '3'" v-model="loop.end" :min="1" :max="7" size="mini" style="width: 100px;"></el-input-number>
      {{$i18n.t('components.minMsg5')}}
    </div>
    <div>
      <el-radio v-model="type" label="7" size="mini" border>{{$i18n.t('components.minMsg6')}}</el-radio>
      <span style="margin-left: 10px; margin-right: 5px;">{{$i18n.t('components.minMsg7')}}</span>
      <el-input-number @change="type = '7'" v-model="week.start" :min="1" :max="4" size="mini" style="width: 100px;"></el-input-number>
      <span style="margin-left: 5px; margin-right: 5px;">{{$i18n.t('components.minMsg8')}}</span>
      <el-input-number @change="type = '7'" v-model="week.end" :min="1" :max="7" size="mini" style="width: 100px;"></el-input-number>
    </div>
    <div>
      <el-radio v-model="type" label="6" size="mini" border>{{$i18n.t('components.minMsg9')}}</el-radio>
      <span style="margin-left: 10px; margin-right: 5px;">{{$i18n.t('components.week')}}</span>
      <el-input-number @change="type = '6'" v-model="last" :min="1" :max="7" size="mini" style="width: 100px;"></el-input-number>
    </div>
    <div>
      <el-radio v-model="type" label="4" size="mini" border>{{$i18n.t('components.assign')}}</el-radio>
