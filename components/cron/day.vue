<template lang="html">
  <div :val="value_">
    <div>
      <el-radio v-model="type" label="1" size="mini" border>{{$i18n.t("components.everyday")}}</el-radio>
    </div>
    <div>
    ...
    <div>
      ...
      <span style="margin-left: 5px; margin-right: 5px;">{{ $i18n.t("components.dayMsg1") }}</span>
      <el-input-number @change="type = '3'" v-model="loop.end" :min="1" :max="31" size="mini" style="width: 100px;"></el-input-number>
      {{ $i18n.t("components.dayMsg2") }}
    </div>
    <div>
      <el-radio v-model="type" label="8" size="mini" border>{{ $i18n.t("components.workday") }}</el-radio>
      <span style="margin-left: 10px; margin-right: 5px;">{{ $i18n.t("components.isMonth") }}</span>
      <el-input-number @change="type = '8'" v-model="work" :min="1" :max="7" size="mini" style="width: 100px;"></el-input-number>
      {{ $i18n.t("components.dayMsg3") }}
    </div>
    <div>
      <el-radio v-model="type" label="6" size="mini" border>{{ $i18n.t("components.lastMonth") }}</el-radio>
    </div>
    <div>
