<template>
  <div
    class="ele-form ele-form-tip-pack"
                  ...
                  <div style="width: 100%;">
                    <el-col
                      ...
                      :class="{
                        ...
                        'w-auto': formItem.wAuto,
                      }"
                      :style="{
                        float:
                          formItem.wAuto || formItem.noBorder ? 'left' : 'none',
                      }"
                    >
                      <el-form-item
                        :class="
                          formItem.noBorder && formItem._label == 'hidden'
                            ? 'hidden-label'
                            : ''
                        "
                      ...
                      >
                        ...
                        <div
                          ...
                          v-if="formItem._tip"
                        >
                          <div class="ele-form-tip ele-form-tip-item">
                            <i
                              style="padding-right: 5px; color: #b6c0c9;"
                              class="el-icon-question"
                            ></i>
                            <span>{{ formItem._tip }}</span>
                            <div style="clear: both;"></div>
                          </div>
                          <div style="clear: both;"></div>
                        </div>
                      </el-form-item>
                      <div class="hr" v-if="!formItem.noBorder">
                        <div class="hr--pack"></div>
                      </div>
                    </el-col>
                  </div>
                </slot>
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      setTimeout(() => {
        let dom = document.querySelectorAll(".ele-form-tip-item");
        for (let i = 0; i < dom.length; i++) {
          let ite = dom[i];
          let w =
            ite.parentNode.parentNode.parentNode.parentNode.parentNode
              .offsetWidth;
          let h = ite.offsetHeight;
          ite.style.width = w + "px";
          ite.parentNode.style.height = h + "px";
          // console.log(1111, w, h);
          // ite.parentNode.parentNode.parentNode.style.width = "auto";
        }
      }, 100);
    });
  },
